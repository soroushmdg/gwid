...
plot(ibd_data,y = c("cases","cont1","cont2","cont3"),ly = FALSE) 
...
plot(ibd_data,y = c("cases","cont1","cont2","cont3"),snp_start = 117026294,snp_end = 122613594,ly = FALSE) 

# profile plot of cases
plot(ibd_data,plot_type = "profile")
```
